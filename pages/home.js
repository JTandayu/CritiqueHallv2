        ...
        <main className={useColorModeValue(styles.container, styles.container2)}>
          ...
          <Box bgColor={useColorModeValue('#E5E5E5', '#2E2E2E')} w="100%" h={{lg: '75vh', md: '100%', sm: '100%'}} display={{lg: 'flex', md: 'block', sm: 'block', base: 'block'}} boxShadow='lg'>
            <Flex mt={{lg: 44, base: '40%'}} flexDir={{lg: 'column', base: 'column'}} align='center' w={{lg: '50vw', md: '100%', sm: '100%', base: "100%"}}>
              ...
              <br />
              <Image src={Desc1} w={{lg: '800px', base: "85%"}} h={{lg: '150px'}} ml={{lg: '30%', base: 0}}/>
              <br />
              <Image src={Desc2} w={{lg: '800px', base: "85%"}} h={{lg: '120px'}} ml={{lg: '30%', base: 0}}/>
          ...
          <Box w="100%" h={{lg: "25vh", base: "100%"}} bgColor={useColorModeValue("#E7E7E7", "#2E2E2E")} p={7} display="flex" flexDir={{base: "column", lg: "row"}}>
            <Box w={{lg: "50%", base: "100%"}}>
                <Heading fontSize={{lg: '3xl', base: '3xl'}} ml={{lg: '35%', base: '30%'}} fontFamily={'Raleway'} color={useColorModeValue("#C1272D", "#FF5C61")}>Our Story</Heading>
            ...
            <Spacer />
            <Box w={{lg: "50%", base: "100%"}}>
                <Heading size="xl" w="full" fontFamily={'Raleway'} fontSize={{lg: '3xl', base: '3xl'}} color={useColorModeValue("#C1272D", "#FF5C61")} ml={{lg: '35%', base: '10%'}} mt={{lg: 1, base: 5}}>The Researchers</Heading>
                <Box w="full" mt={5}>
                    <SimpleGrid columns={{lg: 2, md: 2, sm: 1, base: 1}} spacing={5}>
                        <Box w={{lg: "30em", base: "100%"}} px={{lg: 3, base: 3}}>
                            <Flex>
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} color={useColorModeValue("#29226E", "#B2A3FF")}>Azariah Danizar G. Concepcion</Text>
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} ml={{lg: 5, base: '4vh'}}>Back-end Dev</Text>
                            </Flex>
                            <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} ml={{base: '10vh'}} mt={{base: 2}}>(+63) 949 846 0846</Text>
                        </Box>
                        <Box w={{lg: "30em", base: "100%"}} px={{lg: 3, base: 3}}>
                            <Flex> 
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} color={useColorModeValue("#29226E", "#B2A3FF")}>Richie Gene R. Tan</Text>
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} ml={{lg: 8, base: '10vh'}}>UI/UX Designer</Text>
                            </Flex>
                            <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} ml={{base: '10vh'}} mt={{base: 2}}>(+63) 916 424 9531</Text>
                        </Box>
                        <Box w={{lg: "30em", base: "100%"}} px={{lg: 3, base: 3}}>
                            <Flex>
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} color={useColorModeValue("#29226E", "#B2A3FF")}>Jomari L. Matias</Text>
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} ml={{lg: 5, base: '8vh'}}>Project Documentarian</Text>
                            </Flex>
                            <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} ml={{base: '10vh'}} mt={{base: 2}}>(+63) 998 084 4162</Text>
                        </Box>
                        <Box w={{lg: "30em", base: "100%"}} px={{lg: 3, base: 3}}>
                            <Flex>
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} color={useColorModeValue("#29226E", "#B2A3FF")}>Jose Luis P. Tandayu</Text>
                                <Text fontFamily={'Raleway'} fontSize={{lg: 'lg', base: 'xs'}} ml={{lg: 5, base: '8vh'}}>Front-end Dev</Text>
                            </Flex>
