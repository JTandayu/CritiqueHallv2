        ...
        >
          ...
          <Button
            ...
            <SimpleGrid columns={{lg: 2, base: 1}} spacing={{lg: 2, base: 2}} mt={'5%'}>
                ...
                <Input size={{lg: 'lg', base: 'sm'}} width={{lg:'35vh', base: '90%'}} borderColor={useColorModeValue('black', 'white')} placeholder="No spaces/underscores, please!" className={styles.input_box} type="text" value={user_name} onChange={e => setUserName(e.target.value)}/>
                </Box>
                <Box>
