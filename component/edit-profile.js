        ...
        <Modal isOpen={isOpen} onClose={onClose}>
            <ModalOverlay />
                ...
                <ModalBody>
                    ...
                    <Flex>
                        <Spacer />
                        <Button fontFamily={'Raleway'} bgColor={useColorModeValue('#0C1F83', '#1D447E')} color={useColorModeValue('white', 'white')} _hover={{bgColor: useColorModeValue('#173cff', '#428eff')}} mr={3} onClick={SubmitInfo}>Save</Button>
                    </Flex>
                    <Divider mb={5} mt={5}/>
                    <Flex>
