            ...
            <ModalOverlay />
                ...
                <ModalBody>
                    ...
                    <Flex mb={5} flexDir={{lg: "row", base: "column"}}>
                        ...
                        <Input fontFamily={'Raleway'} borderColor={useColorModeValue('black', 'white')} type='password' w={{lg: '14vw', base: "100%"}} ml={{lg: '10px', base: 0}} onChange={(e) => setConfirmPassword(e.target.value)} />
